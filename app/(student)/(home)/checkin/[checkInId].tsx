          ...
          {currentQ.question_type === "text" ? (
              ...
              {Array.from({ length: 10 }, (_, i) => i + 1).map((n) => (
                ...
                >
                  <Text className={`text-lg font-black ${
                    answers[currentQ.id] === n ? "text-dark-400" : "text-text-primary"
                  }`}>
                    {n}
                  </Text>
                </Pressable>
            ...
            <View className="flex-row gap-4">
              {["Sim", "Nao"].map((opt) => (
                ...
                >
                  <Text className={`text-lg font-black ${
                    answers[currentQ.id] === opt ? "text-dark-400" : "text-text-primary"
                  }`}>
                    {opt}
                  </Text>
                </Pressable>
        ...
        <View className="flex-row gap-3 py-6">
          ...
          >
            {submitCheckIn.isPending ? (
              ...
              <Text className="text-dark-400 font-black text-sm uppercase">
